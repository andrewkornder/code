...
def get_list_videos():
    ...
    # Create API Object
    api = Api(api_key='AIzaSyDfd5Ty9FIlzj-v2guDQndQm8tD9gTcbvM')
    ...
    for videoid in playlist_item_by_id['items']:
        list_box.insert(tkinter.END, videoid['contentDetails']['videoId'])
        all_videos.append(videoid['contentDetails']['videoId'])
...
def download_videos():
    ...
    for videoid in all_videos:  # list_box.curselection():
